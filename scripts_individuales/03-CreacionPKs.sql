...
BEGIN
	...
	ADD CONSTRAINT PK_VENTA_POR_CUPON_CODIGO PRIMARY KEY (CUPON_CODIGO)
...
IF NOT EXISTS (SELECT * 
    		   FROM INFORMATION_SCHEMA.TABLE_CONSTRAINTS
               WHERE CONSTRAINT_NAME ='PK_VENTA_POR_CUPON_VENTA_CODIGO')
BEGIN
	ALTER TABLE HARAKIRI.VENTA_POR_CUPON
	ADD CONSTRAINT PK_VENTA_POR_CUPON_VENTA_CODIGO PRIMARY KEY (VENTA_CODIGO)
	PRINT('Primary key de la tabla HARAKIRI.VENTA_POR_CUPON agregada')
END
GO
