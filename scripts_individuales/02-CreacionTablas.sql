...
BEGIN
	...
	CLIENTE_CODIGO decimal(19,0) NOT NULL,
        ...
        CLIENTE_LOCALIDAD_CODIGO decimal(18,0)
        )
...
BEGIN
	...
	MATERIAL_CODIGO decimal(18,0) NOT NULL,
...
BEGIN
	CREATE TABLE HARAKIRI.CUPON_TIPO (
        CUPON_TIPO_CODIGO decimal(19,0) NOT NULL,
...
BEGIN
	CREATE TABLE HARAKIRI.DESCUENTO_CONCEPTO (
        ...
        DESCUENTO_CONCEPTO_NOMBRE nvarchar(255)
        )
...
BEGIN
	CREATE TABLE HARAKIRI.DESCUENTO_POR_VENTA (
        DESCUENTO_CODIGO decimal(19,0) NOT NULL,
        DESCUENTO_CONCEPTO_CODIGO decimal(19,0),
        VENTA_CODIGO decimal(19,0),
