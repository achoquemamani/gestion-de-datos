...
IF EXISTS (SELECT * 
    		   FROM INFORMATION_SCHEMA.REFERENTIAL_CONSTRAINTS 
               WHERE CONSTRAINT_NAME ='FK_CUPON_TIPO_CODIGO')
BEGIN
	ALTER TABLE HARAKIRI.CUPON DROP CONSTRAINT FK_CUPON_TIPO_CODIGO
END
GO
...
IF EXISTS (SELECT * 
    		   FROM INFORMATION_SCHEMA.REFERENTIAL_CONSTRAINTS 
               WHERE CONSTRAINT_NAME ='FK_VENTA_POR_CUPON_CODIGO')
BEGIN
	ALTER TABLE HARAKIRI.VENTA_CUPON DROP CONSTRAINT FK_VENTA_POR_CUPON_CODIGO
END
GO
...
BEGIN
	ALTER TABLE HARAKIRI.VENTA_CUPON DROP CONSTRAINT FK_VENTA_POR_CUPON_VENTA_CODIGO
END
GO
...
BEGIN
	ALTER TABLE HARAKIRI.DESCUENTO_POR_VENTA DROP CONSTRAINT FK_DESCUENTO_POR_VENTA_DESCUENTO_CONCEPTO_CODIGO
END
GO

IF EXISTS (SELECT * 
    		   FROM INFORMATION_SCHEMA.REFERENTIAL_CONSTRAINTS 
               WHERE CONSTRAINT_NAME ='FK_DESCUENTO_POR_VENTA_VENTA_CODIGO')
BEGIN
	ALTER TABLE HARAKIRI.DESCUENTO_POR_VENTA DROP CONSTRAINT FK_DESCUENTO_POR_VENTA_VENTA_CODIGO
END
GO
...
>>>>>>> 147687662ae0eb26d7e1e05a397649f77767b922
