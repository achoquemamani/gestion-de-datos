...
BEGIN
	ALTER TABLE HARAKIRI.PRODUCTO_VARAINTE DROP CONSTRAINT FK_PRODUCTO_VARIANTE_VARIANTE
END
GO
...
BEGIN
	ALTER TABLE HARAKIRI.VARIANTE DROP CONSTRAINT FK_PRODUCTO_VARIANTE_TIPO_VARIANTE
END
GO
...
BEGIN
	ALTER TABLE HARAKIRI.FK_VENTA_POR_PRODUCTO_PRODUCTO_VARIANTE DROP CONSTRAINT FK_VENTA_POR_PRODUCTO_PRODUCTO_VARIANTE
END
GO
...
BEGIN
	...
	ADD CONSTRAINT PK_VENTA PRIMARY KEY (PRODUCTO_VARIANTE_CODIGO,VENTA_CODIGO)
...
BEGIN
	ALTER TABLE HARAKIRI.VENTA
	ADD CONSTRAINT FK_VENTA_VENTA_POR_CUPON FOREIGN KEY(VENTA_CUPON_CODIGO) REFERENCES HARAKIRI.CANAL(CUPON_CODIGO)
...
IF NOT EXISTS (SELECT * 
    		   FROM INFORMATION_SCHEMA.REFERENTIAL_CONSTRAINTS 
               WHERE CONSTRAINT_NAME ='FK_VENTA_MEDIO_ENVIO_POR_LCOALIDAD')
BEGIN
	ALTER TABLE HARAKIRI.VENTA
	ADD CONSTRAINT FK_VENTA_MEDIO_ENVIO_POR_LCOALIDAD FOREIGN KEY(VENTA_CANAL_CODIGO) REFERENCES HARAKIRI.MEDIO_ENVIO_POR_LOCALIDAD(MEDIO_ENVIO_POR_LOCALIDAD_CODIGO)
	PRINT('Foreign key entre las tablas HARAKIRI.VENTA y HARAKIRI.CANAL agregada')
END
GO
