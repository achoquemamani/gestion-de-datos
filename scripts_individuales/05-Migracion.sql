...
GO
CREATE PROCEDURE HARAKIRI.RELLENAR_TABLA_VARIANTE
AS
BEGIN
...
GO
CREATE PROCEDURE HARAKIRI.RELLENAR_TABLA_TIPO_VARIANTE
AS
BEGIN
...
GO
CREATE PROCEDURE HARAKIRI.RELLENAR_TABLA_MARCA
AS
BEGIN
...
GO
CREATE PROCEDURE HARAKIRI.RELLENAR_TABLA_CATEGORIA
AS
BEGIN
...
GO
CREATE PROCEDURE HARAKIRI.RELLENAR_TABLA_MATERIAL
AS
BEGIN
...
GO
CREATE PROCEDURE HARAKIRI.RELLENAR_TABLA_PRODUCTO
AS
BEGIN
...
FROM gd_esquema.Maestra MA JOIN HARAKIRI.MARCA M ON MA.PRODUCTO_MARCA = M.NOMBRE 
JOIN HARAKIRI.MATERIAL MT ON MA.PRODUCTO_MATERIAL = MT.NOMBRE 
JOIN HARAKIRI.CATEGORIA CA ON MA.PRODUCTO_CATEGORIA = CA.NOMBRE 
...
EXEC   HARAKIRI.RELLENAR_TABLA_PRODUCTO
EXEC  HARAKIRI.RELLENAR_TABLA_MARCA
EXEC  HARAKIRI.RELLENAR_TABLA_MATERIAL
EXEC  HARAKIRI.RELLENAR_TABLA_CATEGORIA
EXEC  HARAKIRI.RELLENAR_TABLA_TIPO_VARIANTE
EXEC  HARAKIRI.RELLENAR_TABLA_VARIANTE