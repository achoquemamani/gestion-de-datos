...
CREATE TABLE HARAKIRI.BI_HECHO_VENTA_PRODUCTO(
    ...
    CANT_ENVIO_MES_MDP  decimal(18,2),
...
AS
BEGIN
INSERT INTO HARAKIRI.BI_HECHO_VENTA_PRODUCTO (EDAD_CODIGO, TIEMPO_CODIGO, PROVINCIA_CODIGO, CANAL_CODIGO, MEDIO_DE_PAGO_CODIGO, CATEGORIA_CODIGO, PRODUCTO_CODIGO, MEDIO_ENVIO_CODIGO, ENVIO_PRECIO_MES_PROV_MDE, CANT_ENVIO_MES_PROV_MDE,CANT_ENVIO_MES_MDP, PRODUCTO_PRECIO_TOTAL)
SELECT
	VISTA.EDAD_CODIGO,
	VISTA.TIEMPO_CODIGO,
	...
	(
		...
		INNER JOIN HARAKIRI.BI_MEDIO_DE_PAGO BI_MP ON BI_MP.MEDIO_DE_PAGO_NOMBRE = MPV.MEDIO_DE_PAGO_NOMBRE
	 	WHERE 
			T.TIEMPO_CODIGO = VISTA.TIEMPO_CODIGO AND
		    BI_MP.MEDIO_DE_PAGO_CODIGO = VISTA.MEDIO_DE_PAGO_CODIGO
	) CANT_ENVIO_MES_MDP,
...
PRINT('Vista HARAKIRI.PRODUCTOS_CON_MAYOR_RENTABILIDAD_ANUAL creada. Cant filas: ' + @CANTIDAD_REGISTROS)
...
AS
SELECT SUM(VP.PRODUCTO_PRECIO_TOTAL) AS INGRESOS_TOTALES,SUM(VP.PRODUCTO_PRECIO_TOTAL)-CANT_ENVIO_MES_PROV_MDE*MDP.MEDIO_DE_PAGO_COSTO AS INGRESOS_TOTALES_MENOS_COSTO , T.TIEMPO_ANIO , T.TIEMPO_MES ,MDP.MEDIO_DE_PAGO_NOMBRE,CANT_ENVIO_MES_PROV_MDE
FROM HARAKIRI.BI_HECHO_VENTA_PRODUCTO VP 
