...
AS
BEGIN
INSERT INTO HARAKIRI.BI_HECHO_VENTA_DESCUENTO (TIPO_DESCUENTO_CODIGO,  TIEMPO_CODIGO, CANAL_CODIGO,DESCUENTO_IMPORTE)
...
ORDER BY VISTA.TIPO_DESCUENTO_CODIGO, VISTA.TIEMPO_CODIGO,VISTA.CANAL_CODIGO
