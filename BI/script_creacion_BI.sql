...
CREATE TABLE HARAKIRI.BI_COMPRA(
...
IF NOT EXISTS (SELECT * 
    		   FROM INFORMATION_SCHEMA.TABLE_CONSTRAINTS
               WHERE CONSTRAINT_NAME ='PK_BI_COMPRA')
BEGIN
	ALTER TABLE HARAKIRI.BI_COMPRA
	ADD CONSTRAINT PK_BI_COMPRA PRIMARY KEY (BI_COMPRA_CODIGO)
	PRINT('Primary key de la tabla HARAKIRI.BI_COMPRA agregada')
END
GO
...
IF NOT EXISTS (SELECT * 
    		   FROM INFORMATION_SCHEMA.REFERENTIAL_CONSTRAINTS 
               WHERE CONSTRAINT_NAME ='FK_BI_HECHO_COMPRA_PRODUCTO_BI_COMPRA')
BEGIN
	ALTER TABLE HARAKIRI.BI_HECHO_COMPRA_PRODUCTO
	ADD CONSTRAINT FK_BI_HECHO_COMPRA_PRODUCTO_BI_COMPRA FOREIGN KEY(COMPRA_CODIGO) REFERENCES HARAKIRI.BI_COMPRA(COMPRA_CODIGO)
	PRINT('Foreign key entre las tablas HARAKIRI.BI_HECHO_COMPRA_PRODUCTO y HARAKIRI.BI_COMPRA agregada')
END
GO
