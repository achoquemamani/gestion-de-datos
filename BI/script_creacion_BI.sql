...
SELECT 
	SUM(VP.PRODUCTO_PRECIO_TOTAL) - SUM(VP.CANT_ENVIO_MES_MDP_CV) * MDP.MEDIO_DE_PAGO_COSTO - (
		...
		FROM HARAKIRI.BI_HECHO_VENTA_DESCUENTO BHVI
...
JOIN HARAKIRI.BI_TIEMPO T ON VP.TIEMPO_CODIGO = T.TIEMPO_CODIGO
JOIN HARAKIRI.BI_HECHO_VENTA_DESCUENTO HVD ON HVD.TIEMPO_CODIGO = T.TIEMPO_CODIGO AND HVD.MEDIO_DE_PAGO_CODIGO = MDP.MEDIO_DE_PAGO_CODIGO

GROUP BY T.TIEMPO_CODIGO, HVD.MEDIO_DE_PAGO_CODIGO, MDP.MEDIO_DE_PAGO_COSTO
ORDER BY T.TIEMPO_CODIGO, HVD.MEDIO_DE_PAGO_CODIGO
GO
...
/*
SELECT TIEMPO_CODIGO,MEDIO_DE_PAGO_CODIGO,SUM(DESCUENTO_IMPORTE) FROM HARAKIRI.BI_HECHO_VENTA_DESCUENTO
GROUP BY TIEMPO_CODIGO,MEDIO_DE_PAGO_CODIGO
*/
