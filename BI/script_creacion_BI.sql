...
BEGIN
    ...
    PRINT('Vista HARAKIRI.TOP_5_CATEGORIAS_VENDIDAS_X_RANGO_ETARIO_CLIENTES_X_MES eliminada')
END
GO
...
IF OBJECT_ID('HARAKIRI.TOP_3_PRODUCTOS_CON_MAYOR_REPOSICION_MENSUAL') IS NOT NULL
BEGIN
	DROP VIEW HARAKIRI.TOP_3_PRODUCTOS_CON_MAYOR_REPOSICION_MENSUAL
    PRINT('Vista HARAKIRI.TOP_3_PRODUCTOS_CON_MAYOR_REPOSICION_MENSUAL eliminada')
END
GO
...
CREATE VIEW HARAKIRI.TOP_3_PRODUCTOS_CON_MAYOR_REPOSICION_MENSUAL
AS
...
DECLARE @CANTIDAD_REGISTROS NVARCHAR(255)
SET @CANTIDAD_REGISTROS = (SELECT COUNT(*) FROM HARAKIRI.TOP_3_PRODUCTOS_CON_MAYOR_REPOSICION_MENSUAL)
PRINT('View TOP_3_PRODUCTOS_CON_MAYOR_REPOSICION_MENSUAL creada. Cant filas: ' + @CANTIDAD_REGISTROS)