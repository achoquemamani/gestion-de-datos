...
IF OBJECT_ID('HARAKIRI.GANANCIAS_MENSUALES_X_MES') IS NOT NULL
BEGIN
	DROP VIEW HARAKIRI.GANANCIAS_MENSUALES_X_MES
    PRINT('Vista HARAKIRI.GANANCIAS_MENSUALES_X_MES eliminado')
END
GO
...
(
 SELECT COUNT(*)
	...
	JOIN HARAKIRI.BI_PROVINCIA P2 ON VP2.PROVINCIA_CODIGO = P2.PROVINCIA_CODIGO
...
AS
SELECT T.TIEMPO_ANIO, P.PROVINCIA_NOMBRE, MEDIO_ENVIO_NOMBRE,AVG(VP.VENTA_ENVIO_PRECIO)
...
WHERE MDE.MEDIO_ENVIO_CODIGO <> 5
