...
AS
BEGIN 
  INSERT INTO HARAKIRI.VENTA (VENTA_CODIGO, VENTA_CANAL_CODIGO, VENTA_CUPON_CODIGO, VENTA_MEDIO_DE_PAGO_CODIGO, VENTA_CLIENTE_CODIGO, VENTA_MEDIO_ENVIO_POR_LOCALIDAD_CODIGO, VENTA_FECHA, VENTA_TOTAL)
  SELECT DISTINCT
    M.VENTA_CODIGO,
    C.CANAL_CODIGO VENTA_CANAL_CODIGO,
    VPC.VENTA_POR_CUPON_CODIGO VENTA_CUPON_CODIGO,
  ...
  JOIN HARAKIRI.VENTA_POR_CUPON VPC on VPC.VENTA_CODIGO = M.VENTA_CODIGO AND VPC.CUPON_CODIGO = M.VENTA_CUPON_CODIGO
  JOIN HARAKIRI.MEDIO_DE_PAGO_VENTA MPV on MPV.MEDIO_DE_PAGO_NOMBRE = M.VENTA_MEDIO_PAGO
  JOIN HARAKIRI.CLIENTE CL on CL.CLIENTE_DNI = M.CLIENTE_DNI
  JOIN HARAKIRI.LOCALIDAD L on L.LOCALIDAD_NOMBRE = M.CLIENTE_LOCALIDAD
...
AS
BEGIN
  INSERT INTO HARAKIRI.COMPRA_POR_PRODUCTO
...
/*select * from HARAKIRI.COMPRA
select * from HARAKIRI.CUPON
select * from HARAKIRI.MEDIO_ENVIO_POR_LOCALIDAD
select * from HARAKIRI.CLIENTE
select * from HARAKIRI.MEDIO_DE_PAGO_VENTA*/
